 ...
 * Generated at: 2018-04-28 06:41:31 UTC
...
public final class areaCheckbox_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<a class=\"waves-effect waves-button\" href=\"javascript:;\" onclick=\"workLocationDialog.close();\">取消</a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</form>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("var areaCheckMap;\r\n");
      out.write("$(function () {\r\n");
      out.write("    areaCheckMap = null;\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("function disabledArea(id) {\r\n");
      out.write("    if(!document.getElementById(id).hasAttribute(\"checked\")){\r\n");
      out.write("        document.getElementById(id).setAttribute(\"checked\",\"checked\");\r\n");
      out.write("        var elements = document.getElementById(\"addTab\").getElementsByTagName(\"input\");\r\n");
      out.write("        for(var i =0;i<elements.length;i++){\r\n");
      out.write("            elements[i].setAttribute(\"disabled\",\"disabled\");\r\n");
      out.write("        }\r\n");
      out.write("    }else{\r\n");
      out.write("        document.getElementById(id).removeAttribute(\"checked\");\r\n");
      out.write("        var elements = document.getElementById(\"addTab\").getElementsByTagName(\"input\");\r\n");
      out.write("        for(var i =0;i<elements.length;i++){\r\n");
      out.write("            elements[i].removeAttribute(\"disabled\");\r\n");
      out.write("        }\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function queryArea(id, index) {\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\ttype: 'get',\r\n");
      out.write("\t\turl: '");
      ...
      out.write("            var jsonObj = jQuery.parseJSON(result);\r\n");
      ...
      out.write("            htmlStr += '<table width=\"100%\" id=\"addTab\">';\r\n");
      out.write("\t\t\thtmlStr += '<tr>';\r\n");
      out.write("\t\t\tvar s = 1;\r\n");
      out.write("            for (var key in jsonObj) {\r\n");
      out.write("                htmlStr += '<td>';\r\n");
      out.write("\t\t\t\thtmlStr += '<input type=\"checkbox\" id=\"'+key+'\" name=\"workLocation\" value=\"'+key+'\" style=\"display:inline-block;\" class=\"dis\">';\r\n");
      out.write("\t\t\t\thtmlStr += '<output style=\"display:inline-block;\" >'+jsonObj[key]+'</output>';\r\n");
      out.write("\t\t\t\thtmlStr += '</td>';\r\n");
      out.write("                if(s%5==0){\r\n");
      out.write("                    htmlStr += '</tr>';\r\n");
      out.write("                    htmlStr += '<tr>';\r\n");
      ...
      out.write("            htmlStr += '</tr>';\r\n");
      out.write("\r\n");
      out.write("            if(areaCheckMap == null){\r\n");
      out.write("                //展开\r\n");
      ...
      out.write("                var oldId;\r\n");
      out.write("                //展开新省级城市\r\n");
      out.write("                if(areaCheckMap[id] == null) {\r\n");
      out.write("                    for (var k in areaCheckMap) {\r\n");
      out.write("                        //删除原来展开\r\n");
      out.write("                        oldId = k;\r\n");
      out.write("                        var y = Math.ceil(areaCheckMap[k] / 5);\r\n");
      ...
      out.write("                    }\r\n");
      out.write("                    //删除原来展开\r\n");
      out.write("                    delete areaCheckMap[oldId];\r\n");
      out.write("                    //新增展开\r\n");
      out.write("                    areaCheckMap[id] = index;\r\n");
      out.write("                }else{\r\n");
      out.write("                    for (var k in areaCheckMap) {\r\n");
      out.write("                        //删除当前展开\r\n");
      out.write("                        oldId = k;\r\n");
      ...
      out.write("        data: null,\r\n");
      out.write("        success: function(result) {\r\n");
      out.write("            areaCheckMap = jQuery.parseJSON(result);\r\n");
      out.write("        },\r\n");
      out.write("        error: function(XMLHttpRequest, textStatus, errorThrown) {\r\n");
      out.write("            alert(XMLHttpRequest.status);\r\n");
      out.write("            alert(XMLHttpRequest.readyState);\r\n");
      ...
      out.write("    workLocationIds = $('#queryForm').serialize();\r\n");
      out.write("\r\n");
      out.write("    var arr = $('#queryForm').serialize().split(\"&\");\r\n");
      out.write("    var ids = \"\";\r\n");
      out.write("    for(var pro in arr){\r\n");
      out.write("        ids += arr[pro].split(\"=\")[1] + \",\";\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("    $.ajax({\r\n");
      out.write("        type: 'get',\r\n");
      out.write("        url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${basePath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/manage/area/query/'+ ids,\r\n");
      out.write("        data: null,\r\n");
      out.write("        success: function(result) {\r\n");
      out.write("            document.getElementById(\"workLocationName\").innerHTML = result;\r\n");
      out.write("        },\r\n");
      out.write("        error: function(XMLHttpRequest, textStatus, errorThrown) {\r\n");
      out.write("            alert(XMLHttpRequest.status);\r\n");
      out.write("            alert(XMLHttpRequest.readyState);\r\n");
      ...
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    workLocationDialog.close();\r\n");
      out.write("}\r\n");
      out.write("</script>  ");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/manage/areaCheckbox.jsp(8,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("basePath");
      // /WEB-INF/jsp/manage/areaCheckbox.jsp(8,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/manage/areaCheckbox.jsp(13,5) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/jsp/manage/areaCheckbox.jsp(13,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("item");
      // /WEB-INF/jsp/manage/areaCheckbox.jsp(13,5) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\" name=\"workLocation\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${item.key}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\" style=\"display:inline-block;\" onclick=\"disabledArea('");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${item.key}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("')\">\r\n");
            out.write("\t\t\t\t\t\t<output onclick=\"queryArea('");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${item.key}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("', '");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/jsp/manage/areaCheckbox.jsp(18,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
