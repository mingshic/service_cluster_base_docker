 ...
 * Generated at: 2018-04-28 02:09:43 UTC
...
public final class rmsTalentCertificateUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("    var certificate = null;\r\n");
      ...
      out.write("/manage/talent/rmsTalentCertificate/list',\r\n");
      ...
      out.write("            idField: 'certificateId',\r\n");
      out.write("            toolbar: '#toolbar',\r\n");
      out.write("            columns: [\r\n");
      out.write("                {field: 'getDate', title: '获得时间', align: 'center', with: '10%',\r\n");
      out.write("                    //——修改——获取日期列的值进行转换\r\n");
      out.write("                    formatter: function (value, row, index) {\r\n");
      out.write("                        return dateFormat_1(value)\r\n");
      out.write("                    }\r\n");
      out.write("                },\r\n");
      out.write("                {field: 'certificateName', title: '证书名称', align: 'center', with: '10%'}\r\n");
      out.write("//                {\r\n");
      out.write("//                    title: '操作',\r\n");
      ...
      out.write("            getCertificate(row.certificateId);\r\n");
      out.write("        }\r\n");
      out.write("    };\r\n");
      out.write("\r\n");
      out.write("    function getCertificate(certificateId) {\r\n");
      out.write("        var arr = $('#updateForm').serialize();\r\n");
      out.write("        $.param(arr);\r\n");
      out.write("        alert(");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${talentId}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("+\":\"+certificateId+\"表单序列化==============\"+arr);\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            type: 'get',\r\n");
      out.write("            url: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${basePath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/manage/talent/rmsTalentCertificate/update/");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${talentId}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/'+certificateId,\r\n");
      out.write("            data: null,\r\n");
      out.write("            success: function(result) {\r\n");
      out.write("                certificate = result;\r\n");
      out.write("\r\n");
      out.write("                var getDate = dateFormat_1(certificate.getDate);\r\n");
      out.write("                $('#dateTimeId').val(getDate);\r\n");
      out.write("\r\n");
      out.write("                $(\"#certificateName\").val(certificate.certificateName);\r\n");
      out.write("\r\n");
      out.write("            },\r\n");
      ...
      out.write("        var certificateId = 0;\r\n");
      out.write("        if('edit' == where){\r\n");
      out.write("            if(null == certificate){\r\n");
      out.write("                alert(\"请点击保存并新增！\");\r\n");
      out.write("            }\r\n");
      out.write("            certificateId = certificate.certificateId;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        var beginlong = new Date(Date.parse($('#dateTimeId').val().replace(/-/g,  \"/\"))).getTime();\r\n");
      out.write("\r\n");
      out.write("        var arr = $('#updateForm').serialize();\r\n");
      out.write("        $.param(arr);\r\n");
      out.write("        arr = arr + \"&getDate=\" + beginlong;\r\n");
      out.write("        alert(");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${talentId}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("+\":\"+certificateId+\"表单序列化==============\"+arr);\r\n");
      out.write("\r\n");
      ...
      out.write("                    );\r\n");
      out.write("\r\n");
      out.write("                    $(\"#dateTimeId\").val(\"\");\r\n");
      out.write("                    $(\"#certificateName\").val(\"\");\r\n");
      out.write("\r\n");
      out.write("                    certificate = null;\r\n");
      out.write("\r\n");
      out.write("                    $.confirm({\r\n");
      out.write("                        title: false,\r\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/manage/talent/rmsTalentCertificateUpdate.jsp(8,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("basePath");
      // /WEB-INF/jsp/manage/talent/rmsTalentCertificateUpdate.jsp(8,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
