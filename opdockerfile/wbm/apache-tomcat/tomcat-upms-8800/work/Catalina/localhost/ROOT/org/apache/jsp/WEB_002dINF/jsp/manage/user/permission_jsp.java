 ...
 * Generated at: 2018-04-16 06:11:40 UTC
...
return;
    ...
    try {
      ...
      if (_jspx_meth_c_005fset_005f0(_jspx_page_context))
        return;
      out.write("\n");
      out.write("<div id=\"permissionDialog\" class=\"crudDialog\">\n");
      out.write("\t<form id=\"permissionForm\" method=\"post\">\n");
      out.write("\t\t<div class=\"row\">\n");
      out.write("\t\t\t<div class=\"col-sm-6\">\n");
      out.write("\t\t\t\t<label>加权限</label>\n");
      ...
      out.write("\t\t\t<a class=\"waves-effect waves-button\" href=\"javascript:;\" onclick=\"permissionSubmit();\">保存</a>\n");
      out.write("\t\t\t<a class=\"waves-effect waves-button\" href=\"javascript:;\" onclick=\"permissionDialog.close();\">取消</a>\n");
      out.write("\t\t</div>\n");
      out.write("\t</form>\n");
      out.write("</div>\n");
      out.write("<script>\n");
      out.write("\tvar changeDatas1 = [];\n");
      out.write("\tvar setting1 = {\n");
      out.write("\t\tcheck: {\n");
      out.write("\t\t\tenable: true,\n");
      out.write("\t\t\t// 勾选关联父，取消关联子\n");
      ...
      out.write("/manage/permission/user/' + permissionUserId + '?type=1'\n");
      out.write("\t\t},\n");
      out.write("\t\tdata: {\n");
      ...
      out.write("\t\t},\n");
      out.write("\t\tcallback: {\n");
      out.write("\t\t\tonCheck: function() {\n");
      out.write("\t\t\t\tvar zTree = $.fn.zTree.getZTreeObj(\"ztree1\")\n");
      out.write("\t\t\t\tvar changeNodes = zTree.getChangeCheckedNodes();\n");
      out.write("\t\t\t\tchangeDatas1 = [];\n");
      out.write("\t\t\t\tfor (var i = 0; i < changeNodes.length; i ++) {\n");
      out.write("\t\t\t\t\tvar changeData = {};\n");
      out.write("\t\t\t\t\tchangeData.id = changeNodes[i].id;\n");
      out.write("\t\t\t\t\tchangeData.checked = changeNodes[i].checked;\n");
      out.write("\t\t\t\t\tchangeData.type = 1;\n");
      out.write("\t\t\t\t\tchangeDatas1.push(changeData);\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t}\n");
      out.write("\t\t}\n");
      out.write("\t};\n");
      out.write("\tvar changeDatas2 = [];\n");
      ...
      out.write("\t\tcallback: {\n");
      out.write("\t\t\tonCheck: function() {\n");
      out.write("\t\t\t\tvar zTree = $.fn.zTree.getZTreeObj(\"ztree2\")\n");
      out.write("\t\t\t\tvar changeNodes = zTree.getChangeCheckedNodes();\n");
      out.write("\t\t\t\tchangeDatas2 = [];\n");
      out.write("\t\t\t\tfor (var i = 0; i < changeNodes.length; i ++) {\n");
      out.write("\t\t\t\t\tvar changeData = {};\n");
      out.write("\t\t\t\t\tchangeData.id = changeNodes[i].id;\n");
      out.write("\t\t\t\t\tchangeData.checked = changeNodes[i].checked;\n");
      out.write("\t\t\t\t\tchangeData.type = -1;\n");
      out.write("\t\t\t\t\tchangeDatas2.push(changeData);\n");
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t}\n");
      out.write("\t\t}\n");
      out.write("\t};\n");
      out.write("\tfunction initTree() {\n");
      out.write("\t\t$.fn.zTree.init($('#ztree1'), setting1);\n");
      out.write("\t\t$.fn.zTree.init($('#ztree2'), setting2);\n");
      out.write("\t}\n");
      out.write("\n");
      out.write("\tfunction permissionSubmit() {\n");
      out.write("\t\t// 合并提交\n");
      out.write("\t\tvar changeDatas = changeDatas1.concat(changeDatas2);\n");
      out.write("\t\t$.ajax({\n");
      out.write("\t\t\ttype: 'post',\n");
      out.write("\t\t\turl: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${basePath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/manage/user/permission/' + permissionUserId,\n");
      out.write("\t\t\tdata: {datas: JSON.stringify(changeDatas), permissionUserId: permissionUserId},\n");
      ...
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t} else {\n");
      out.write("\t\t\t\t\tpermissionDialog.close();\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/jsp/manage/user/permission.jsp(8,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("basePath");
      // /WEB-INF/jsp/manage/user/permission.jsp(8,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
